...
# stop_begin_time = str(datetime.datetime.now())
# online_attempts = [0 for i in range(11)]
# all_molds = dict()
...
#     if not online:
#         s = stop(client, companyID, resourceID, read_datetime, 21,
#                  stop_address, hmi_time_address, user_address, mold_address, current_mold, online)
#         print('online stop adding', s)
#     if scan_status:
...
#                     client, companyID, resourceID, read_datetime, inp_product_address=product_identi_address, behco_address=behco_address, count_address=count_address, current_mold=current_mold, product_address=product_name_address, user_barcode=user)
#                 if pi:
#                     result = 1
...
# def product_identification(client: ModbusClient, companyID, resourceID, read_datetime, inp_product_address: int, behco_address: int, count_address: int, current_mold: int, product_address: int, user_barcode: int):
...
#     if product_transformed != False:
#         validator = val.validate_product(product_transformed, behco)
#         if validator == 1 and product_transformed != False:
#             is_valid = 1
#         elif validator == 3:
#             is_valid = 3
#         else:
...
#     if barcode_base10 != False:
#         validator = val.validate_pack(str(barcode_base36))
#         if validator == 1 and barcode_base10 != False:
#             is_valid = 1
#         elif barcode_base10 == False:
#             is_valid = 3
#         else:
#             is_valid = 2
#         if is_valid == 1:
...
# def stop(client: ModbusClient, companyID, resourceID, read_datetime, status: int, stop_type_address: int, time_address: int, user_barcode: int, mold_number_address: int, current_mold: int, online: bool):
#     if not online:
#         save.stops(companyID, resourceID, read_datetime, 21, '')
#         return True

#     global stop_begin_time

#     stop_type = client.read_holding_registers(stop_type_address)[0]
#     stop_begin_hmi_time = client.read_holding_registers(time_address, 3)
#     stop_begin_hmi_time = f'{stop_begin_hmi_time[0]}:{stop_begin_hmi_time[1]}:{stop_begin_hmi_time[2]}'
#     if status == 1:
#         print('adding begin stop')
#         stop_begin_time = read_datetime
#         save.stops(companyID, resourceID,
#                    stop_begin_time, stop_type, stop_begin_hmi_time, user_barcode=user_barcode)
#     elif status == 2:
#         print('adding end stop')
#         if stop_type == 13:
...
#             if is_mold_valid == True:
#                 save.stops(companyID, resourceID, stop_begin_time,
#                            stop_type, stop_begin_hmi_time, read_datetime, mold_number, user_barcode)
#             else:
#                 return False
#         else:
#             save.stops(companyID, resourceID, stop_begin_time,
#                        stop_type, stop_begin_hmi_time, read_datetime, user_barcode=user_barcode)
#     else:
#         return False
#     return True
...
#             online_attempts[resourceID-1] = 0
#             try:
#                 called = check_called(
#                     client, companyID, resourceID, now, online=reached)
#                 if called:
#                     print('check_called:', called,
#                           '| line number:', resourceID)
#                 packing = packing_called(client, companyID, resourceID, now)
#                 if packing:
#                     print('packing_called:', packing,
#                           '| line number:', resourceID)
#                 # cm = check_mold(
#                 #     client, companyID, resourceID, now)
#                 # if cm:
#                 #     print('check_mold:', cm, '| line number:', resourceID)

#                 # cu = check_user(client, companyID, resourceID, now)
#                 # if cu:
#                 #     print('check_user:', cu, '| line number:', resourceID)

#                 # pi = product_identification(client, companyID, resourceID, now)
#                 # if pi:
#                 #     print('product_identification:', pi,
#                 #           '| line number:', resourceID)

#                 # cprb = check_product_barcode(
#                 #     client, companyID, resourceID, now)
#                 # if cprb:
#                 #     print('check_pack_barcode:', cprb,
#                 #           '| line number:', resourceID)

#                 # cpab = check_pack_barcode(client, companyID, resourceID, now)
#                 # if cpab:
#                 #     print('check_pack_barcode:', cpab,
#                 #           '| line number:', resourceID)

#                 # w = waste(
#                 #     client, companyID, resourceID, now)
#                 # if w:
#                 #     print('waste:', w, '| line number:', resourceID)

#                 # s = stop(client, companyID, resourceID, now)
#                 # if s:
#                 #     print('stop', s, '| line number:', resourceID)

#                 # out = logout(client, companyID, resourceID, now)
#                 # if out:
#                 #     print('logout:', out, '| line number:', resourceID)
...
#         else:
#             online_attempts[resourceID-1] += 1
#             if online_attempts[resourceID-1] == 1:
#                 called = check_called(
#                     client, companyID, resourceID, now, online=reached)
#                 if called:
#                     print('check_called:', called,
